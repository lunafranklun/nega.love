  ...
  window.onload = function() {
    ...
    onWidthChange1();
      if($("img.afterIMGRECTonly").length==0) {
        $( ".actualContentRow" ).before( "<img class='afterIMGRECTonly' style='vertical-align: top; width:1px; position:absolute; visibility: hidden;' src='http://nega.love/empty.gif'>" );
        $( ".actualContentRow" ).before( "<img class='widthCheck' style='vertical-align: top; width:1px; position:absolute; visibility: hidden;' src='http://nega.love/empty.gif'>" );
      }
                      ...
                      var containerRatio = containerHeight/containerWidth;
                        ...
                        if ( ( imgRatio < containerRatio ) && (( (widthCheck > 5 && widthCheck < 13) && (!$(this).find('.imgrectCaptionChild').hasClass('col-xs-alone') ) ) || ( (widthCheck > 14 && widthCheck < 24) && (!$(this).find('.imgrectCaptionChild').hasClass('col-sm-alone') ) ) || ( (widthCheck > 25 && widthCheck < 35) && (!$(this).find('.imgrectCaptionChild').hasClass('col-md-alone') ) ) || ( (widthCheck > 36 && widthCheck < 45) && (!$(this).find('.imgrectCaptionChild').hasClass('col-lg-alone') ) ) )) {
                          ...
                          if (widthCheck > 36 && widthCheck < 42) {
                            $(this).find('.imgrectCaptionChild>img.col-lg-36').css('width', '99.9%').css('height', 'auto');
                            $(this).find('.imgrectCaptionChild>img.col-lg-35').css('width', '88%').css('height', 'auto');
                            $(this).find('.imgrectCaptionChild>img.col-lg-34').css('width', '80%').css('height', 'auto');
                            $(this).find('.imgrectCaptionChild>img.col-lg-33').css('width', '72%').css('height', 'auto');
                            $(this).find('.imgrectCaptionChild>img.col-lg-32').css('width', '99.9%').css('height', 'auto');
                            $(this).find('.imgrectCaptionChild>img.col-lg-31').css('width', '88%').css('height', 'auto');
                            $(this).find('.imgrectCaptionChild>img.col-lg-30').css('width', '80%').css('height', 'auto');
                            $(this).find('.imgrectCaptionChild>img.col-lg-29').css('width', '72%').css('height', 'auto');
                            $(this).find('.imgrectCaptionChild>img.col-lg-28').css('width', '64%').css('height', 'auto');
                            $(this).find('.imgrectCaptionChild>img.col-lg-27').css('width', '56%').css('height', 'auto');
                            $(this).find('.imgrectCaptionChild>img.col-lg-26').css('width', '48%').css('height', 'auto');
                            $(this).find('.imgrectCaptionChild>img.col-lg-25').css('width', '40%').css('height', 'auto');
                            $(this).find('.imgrectCaptionChild>img.col-lg-24').css('width', '32%').css('height', 'auto');
                            $(this).find('.imgrectCaptionChild>img.col-lg-23').css('width', '24%').css('height', 'auto');
                            $(this).find('.imgrectCaptionChild>img.col-lg-22').css('width', '99.9%').css('height', 'auto');
                            $(this).find('.imgrectCaptionChild>img.col-lg-21').css('width', '88%').css('height', 'auto');
                            $(this).find('.imgrectCaptionChild>img.col-lg-20').css('width', '80%').css('height', 'auto');
                            $(this).find('.imgrectCaptionChild>img.col-lg-19').css('width', '72%').css('height', 'auto');
                            $(this).find('.imgrectCaptionChild>img.col-lg-18').css('width', '64%').css('height', 'auto');
                            $(this).find('.imgrectCaptionChild>img.col-lg-17').css('width', '56%').css('height', 'auto');
                            $(this).find('.imgrectCaptionChild>img.col-lg-16').css('width', '48%').css('height', 'auto');
                            $(this).find('.imgrectCaptionChild>img.col-lg-15').css('width', '40%').css('height', 'auto');
                            $(this).find('.imgrectCaptionChild>img.col-lg-14').css('width', '32%').css('height', 'auto');
                            $(this).find('.imgrectCaptionChild>img.col-lg-13').css('width', '24%').css('height', 'auto');
